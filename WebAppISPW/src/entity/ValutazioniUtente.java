...
public class ValutazioniUtente {
    ...
    public ValutazioniUtente(String utente, String data, String descrizione, String lingua, int val_generica,
                             int val_pulizia, int val_educazione, int val_disponibilita) {
        this.utente = utente;
        this.data = data;
