...
public class FiltraggioController {
    ...
    public static FiltraggioController istance;
    ...
    public Filter setFilters(String categoria, String stelle, String lingua, String range) {
        int valore = 0;
        String start;
        String end;
        ...
        Filter filter = new Filter(categoria, lingua, valore, start, end);
        return filter;
    }
