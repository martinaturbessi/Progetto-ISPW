...
public class OrdinamentoController {
    ...
    private static OrdinamentoController istance;

    private OrdinamentoController() {}
    ...
    public ObservableList<ValutazioniUtente> sortUserEvaluations(ObservableList<ValutazioniUtente> uEs, SortingCriterium sC) {
        try {
